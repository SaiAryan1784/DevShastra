    ...
    <div id="prizes" className="relative py-20 px-6 text-white overflow-hidden">
      ...
      <div className="flex justify-center items-end gap-8 flex-wrap z-10 relative mb-20">
        {prizes.map((prize, index) => (
          ...
          >
            <div
              className={`relative bg-stone-800/70 backdrop-blur-sm rounded-xl p-8 border border-amber-700/30 shadow-lg transition-all duration-200 hover:border-amber-600/50 hover:shadow-amber-900/20 ${
                index === 0 ? "h-80" : index === 1 ? "h-72" : "h-64"
              }`}
            >
              <div
                className={`relative ${
                  index === 0 ? "mb-8" : index === 1 ? "mb-7" : "mb-6"
